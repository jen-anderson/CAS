...
const models = [
  'references', 'property_type', 'solvent', 'alias', 'observation', 
  'formula', 'solvent_formula', 'hazard_code', 'p_code', 
  'hazard_classification', 'pcode_group', 'alias_reference', 
  'formula_hazard', 'hazard_pcode', 'pcode_group_map', 
  'solvent_hazard', 'solvent_reference'
];
...
models.forEach(model => {
  const fileName = `${dir}/\${model}.ts`;
  fs.writeFileSync(fileName, template(model));
